...
import { IFileRange, parse as _parse } from "./dot_peggy.ts";
/**
...
export namespace AST {
  ...
  export interface ASTBaseParent<STMT extends ASTBaseNode = ASTBaseNode>
    extends ASTBaseNode {
    body: STMT[];
  }
  ...
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Edge>,
  ): Edge;
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Node>,
  ): Node;
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Graph>,
  ): Graph;
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Attribute>,
  ): Attribute;
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Attributes>,
  ): Attributes;
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Subgraph>,
  ): Subgraph;
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.ClusterStatements>,
  ): ClusterStatement[];
  export function parse(
    dot: string,
    options: ParseOption<typeof Types.Dot>,
  ): Dot;
  export function parse(
    dot: string,
    options: ParseOption,
  ): Dot | Graph | ClusterStatement | ClusterStatement[];
  export function parse(
    dot: string,
    { rule }: ParseOption = {},
  ): Dot | Graph | ClusterStatement | ClusterStatement[] {

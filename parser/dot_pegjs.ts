...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  function peg$parseClusterAttr(): any {
  ...
  function peg$parseedgeTargetGroup(): any {
    let s0, s1, s2, s3, s4;
    s0 = peg$currPos;
    if (input.charCodeAt(peg$currPos) === 123) {
      s1 = peg$c6;
  ...
  function peg$parseedgeTarget(): any {
    let s0, s1;
    s0 = peg$currPos;
  ...
  function peg$parsecompass_pt(): any {
    let s0;

...
export type AttributesEntities<T extends string> = readonly [
  T,
  AttributesValue,
][];
...
export type ClusterSubgraphAttributes = AttributesObject<
  attribute.ClusterSubgraph | attribute.Subgraph
>;
...
export interface IAttributes<T extends string = string>
  extends IAttributesBase<T>, IHasComment {
}
...
export interface ICluster<T extends string = string>
  extends IHasComment, IAttributesBase<T> {
  readonly id?: string;
...
export interface ISubgraph
  extends ICluster<attribute.Subgraph | attribute.ClusterSubgraph> {

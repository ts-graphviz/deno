...
```typescript
import { Digraph, Subgraph, Node, Edge, attribute, toDot } from 'https://deno.land/x/graphviz/mod.ts';
...
```typescript
import { Digraph, Node, Edge, EdgeTarget, attribute, toDot } from 'https://deno.land/x/graphviz/mod.ts';
